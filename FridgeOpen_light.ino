...
int sensorValue = 0, sensorHigh = 0, sensorLow = 1023, lightLevel = 0, tempLevel=0;
const long int tempInterval = 6000;
...
//    Serial.println(lightLevel);
    ...
    if ((millis()-prevWrite) > tempInterval) {
      ...
      Serial.print("T");
      tempLevel = analogRead(0);
      float volti = (tempLevel/1024.0) * 5.0;
      float temperatura = (volti-0.5) * 100;
